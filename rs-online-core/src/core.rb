...
$:.push "/home/#{`whoami`.chomp}/NetBeansProjects/rs-online-core/src"
...
def get_local_path
  arq = File.open("/home/#{`whoami`.chomp}/.rsonline/rs-online.conf", "r")
...
def run
  begin
    begin
      ...
      # show package name
      Verbose.to_log("#: #{pacote.id_pacote}, Pacote: #{pacote.nome}")
      links_before_test = pacote.select_links
...
def singleton?
  arq_conf = "/home/#{`whoami`.chomp}/.rsonline/rs-online.conf"

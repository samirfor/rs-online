				...
				if ( cOption == '<' )
				{
					...
					if ( cNext == "'" || cNext == '"' )
					{
						...
						if ( sAttr == "H" )
						{
							...
							sAttr = "fg-toolbar ui-toolbar ui-state-hover ui-corner-tl ui-corner-tr ui-helper-clearfix";
						}
						else if ( sAttr == "F" )
						{
							//sAttr = "fg-toolbar ui-toolbar ui-widget-header ui-corner-bl ui-corner-br ui-helper-clearfix";
							sAttr = "fg-toolbar ui-toolbar ui-state-hover ui-corner-bl ui-corner-br ui-helper-clearfix";
						}
